...
## İçerik
 - [GitHub](#github)
  ...
  - [Branch](#branch)
    - [Tüm Branch'leri Baska Bir Branch'le Karşılaştırma](#compare-all-branches-to-another-branch)
    - [Branch'leri Karşılaştırma](#comparing-branches)
    - [Fork Edilen Repository'ler Üzerinden Branch Karşılaştırma](#compare-branches-across-forked-repositories)
  - [Gists](#gists)
  - [Git.io](#gitio)
  - [Klavye Kısayolları](#keyboard-shortcuts)
  - [Repository'lerde Satır Vurgulama](#line-highlighting-in-repositories)
  - [Commit Mesajı İle Issue'ları Kapatma](#closing-issues-via-commit-messages)
  - [Çapraz Bağlantı Issue'ları](#cross-link-issues)
  - [Konuşmayı Kilitleme](#locking-conversations)
  - [Pull Request'de Check-in Durumları](#ci-status-on-pull-requests)
  - [Filtreler](#filters)
  - [Markdown Dosyalarında Sentaks Vurgulama](#syntax-highlighting-in-markdown-files)
  - [Emojiler](#emojis)
  - [Resimler/GIF'ler](#imagesgifs)
    - [Github Wiki'de Gömülü Resimler](#embedding-images-in-github-wiki)
  - [Hızlı Alıntılama](#quick-quoting)
  - [Yorumlara Clipboard Resmi Eklemek](#pasting-clipboard-image-to-comments)
  - [Hızlı Lisanslama](#quick-licensing)
  - [Görev Listesi](#task-lists)
    - [Markdown Dökümanlarında Görev Listesi](#task-lists-in-markdown-documents)
  - [İlişkili Linkler](#relative-links)
  - [Github Sayfaları İçin Metadata Ve Eklenti Desteği](#metadata-and-plugin-support-for-github-pages)
  - [Dökümanlarınızda YAML Metadata'sını Görüntüleme](#viewing-yaml-metadata-in-your-documents)
  - [Çizelge Datalarını Göstermek](#rendering-tabular-data)
  - [PDF Göstermek](#rendering-pdf)
  - [Pull Request'i Geri Çevirmek](#revert-a-pull-request)
  - [Değişiklikler](#diffs)
    - [Oluşturulan Artı Değişiklikler](#rendered-prose-diffs)
    - [Değişiklik Haritaları](#diffable-maps)
    - [Değişikliklerde Bağlamı Genişletmek](#expanding-context-in-diffs)
    - [Pull Request Diff Ve Patch](#diff-or-patch-of-pull-request)
    - [Resimleri Kıyaslama](#rendering-and-diffing-images)
  - [Hub](#hub)
  - [Katkı Sağlama Kılavuzu](#contribution-guidelines)
    - [Katkı Sağlama Dosyası](#contributing-file)
    - [ISSUE_TASLAĞI Dosyası](#issue_template-file)
    - [PULL_REQUEST_TASLAĞI Dosyası](#pull_request_template-file)
  - [Octicons](#octicons)
  - [GitHub Öğrenci Geliştirici Paketi](#github-student-developer-pack)
  - [GitHub Kaynakları](#github-resources)
